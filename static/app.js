...
function renderDetail() {
  ...
  <details class="sec" data-sec="alt"><summary><span class="number">02a</span> ALTERNATİF AÇIKLAMA <span class="sec-hint">${i.alternatives.length} hipotez</span></summary><div class="counter">${i.alternatives.map(a=>`<strong>${esc(a.hypothesis)}</strong><p>${esc(a.comparison)}</p><small>Doğrulama: ${esc(a.next_check)}</small>`).join("")}</div></details>
